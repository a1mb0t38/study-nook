    ...
    return (
        ...
        '>
            <div className='w-full space-y-4 max-w-md mx-auto rounded-md bg-white p-9'>
                ...
                <p className='text-center text-base text-gray-800'>Register for an account</p>
                ...
                <div>
                    <form>
                        ...
                        <button className='btn w-full mt-3.5 bg-white text-amber-700
                         font-semibold'>Register</button>
                    </form>
                    <ToastContainer></ToastContainer>
                    <p className='mt-3.5 text-center'>Already have an account <Link className='text-red-700' href={'/login'}>Login</Link> </p>
                </div>
            </div>
        </div>
    );
